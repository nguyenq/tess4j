...
/**
 * A Java wrapper for <code>Tesseract OCR 5.3.0 API</code> using
...
public interface TessAPI extends Library, ITessAPI {
     ...
     * @return 0 on success and -1 on initialization failure
     */
    int TessBaseAPIInit5(TessBaseAPI handle, String data, int data_size, String language, int oem, PointerByReference configs, int configs_size, PointerByReference vars_vec, PointerByReference vars_values, NativeSize vars_vec_size, int set_only_non_debug_params);
